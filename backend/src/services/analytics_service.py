...
class AnalyticsService:
    ...
    async def database_stats() -> dict[str, Any]:
        ...
        return {
            "message": "Resumen general de la base de datos.",
            "kpis": {
    ...
    async def product_count_by_category(limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Categorias con mas productos. Mongo agrupa todo el catalogo y devuelve {len(rows)} filas.",
            "kpis": {
    ...
    async def sales_by_year() -> dict[str, Any]:
        ...
        return {
            "message": "Ventas agregadas por anio usando todos los pedidos.",
            "kpis": {
                "anios": len(rows),
    ...
    async def sales_by_month(year: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Evolucion mensual de ventas{title_year}.",
            "kpis": {
                "meses": len(rows),
    ...
    async def sales_by_category(year: int | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Ventas por categoria{title_year}. Se agregan todos los pedidos y se muestran las {len(rows)} categorias principales.",
            "kpis": {
                "categorias_mostradas": len(rows),
    ...
    async def units_by_category(year: int | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Categorias con mas unidades vendidas. Se muestran {len(rows)} grupos agregados.",
            "kpis": {
                "categorias_mostradas": len(rows),
                "top_categoria": rows[0]["categoria"] if rows else "sin datos",
    ...
    async def top_products(year: int | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Top {len(rows)} productos por ventas{title_year}.",
            "kpis": {
    ...
    async def sales_by_state(year: int | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Ventas por estado{title_year}. Se procesan todos los pedidos y se devuelven {len(rows)} estados.",
            "kpis": {
    ...
    async def sales_by_city(year: int | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Top {len(rows)} ciudades por ventas.",
            "kpis": {
    ...
    async def freight_by_state(year: int | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Coste de envio agrupado por estado sobre todos los pedidos disponibles.",
            "kpis": {
                "estados_mostrados": len(rows),
    ...
    async def freight_by_category(year: int | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": "Coste de envio agrupado por categoria.",
            "kpis": {
                "categorias_mostradas": len(rows),
    ...
    async def average_order_value_by_year() -> dict[str, Any]:
        ...
        return {
            "message": "Ticket medio por anio calculado agrupando primero cada pedido completo.",
            "kpis": {
                "anios": len(rows),
    ...
    async def orders_by_year() -> dict[str, Any]:
        ...
        return {
            "message": "Numero de pedidos por anio.",
            "kpis": {
                "anios": len(rows),
    ...
    async def top_customers(limit: int | None = None) -> dict[str, Any]:
        ...
        return {
            "message": f"Top {len(rows)} clientes por ventas acumuladas.",
            "kpis": {
